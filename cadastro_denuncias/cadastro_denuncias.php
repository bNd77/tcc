<?php
   include "../conexao.php";
    ...
    `endereco_vitima`,`escola_vitima`,`idade_vitima`,`genero_vitima`,`motivo_id_motivo`,`relato`,`data`,`status`) 
     VALUES ('$nome_vitima','$nome_pai','$nome_mae','$endereco','$escola_vitima','$idade','$genero', '$motivo','$relato',now(),'EA')";
